...
class Virus(models.Model):
    ...
    file = models.FileField(upload_to=f'virus/', max_length=50000)
...
class ACE(models.Model):
    patient = models.ForeignKey(Patient,related_name='patient', verbose_name='patient', on_delete=models.CASCADE)
    file = models.FileField(upload_to=f'ace2/', max_length=50000000)
    print(id(patient))
